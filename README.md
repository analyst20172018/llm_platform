...
ORCAROUTER_API_KEY=...
WIRO_API_KEY=...
WIRO_API_SECRET=...  # Optional; required for signature-auth projects
WIRO_API_BASE_URL=...  # Optional API endpoint override
MISTRAL_API_KEY=...
MOONSHOT_API_KEY=...
```
